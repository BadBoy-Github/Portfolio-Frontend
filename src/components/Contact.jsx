...
const socialLinks = [
  ...
  {
    href: "https://wa.me/919842852121",            //TODO: Change the icon to whatsapp
    icon: (
      <svg
        width="25"
        height="24"
    ...
    return (
      <section id="contactme" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
              ...
              {socialLinks.map(({ href, icon }, key) => (
                <a
                  ...
                  className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color]
                                hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80  duration-300"
                >
                  {icon}
                </a>
              ))}
          ...
          <form
            action="https://getform.io/f/bolldxna"
            method="POST"
