      ...
      <div className="container mx-auto relative">
        ...
        <div className="hidden lg:flex justify-between items-center">
          ...
          <button
            ...
            className="absolute z-10 p-4 bg-black/40 rounded-full flex items-center justify-center opacity-50 left-2 top-[53%] group hover:opacity-75 hover:scale-105 transition-all duration-300"
          >
          ...
          <button
            onClick={scrollToEnd}
            className="absolute z-10 p-4 bg-black/40 rounded-full flex items-center justify-center opacity-50 right-2 top-[53%] group hover:opacity-75 hover:scale-105 transition-all duration-300"
          >
